...
import envs
import algorithms.distillation as distillation
import os
import sys
import yaml
import torch
...
def get_args(): # TODO: delve into the arguments
    custom_parameters = [
        ...
        {"name": "--teacher_dir", "type": str, "default": "examples/logs/QuadrotorGSMaskPosTrajGlobal8/shac/gate_right/01-27-2025-13-47-33"}, 
        {"name": "--policy_name", "type": str, "default": "best_policy.pt"}, 
            ]
...
if __name__ == '__main__':
    ...
    traj_optimizer = distillation.Distill(cfg_train)

    if args.train:
        traj_optimizer.distill_policy(args.teacher_dir, args.policy_name)