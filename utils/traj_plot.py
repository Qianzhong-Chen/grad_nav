...
if __name__ == "__main__":
    ...
    destination_positions_torch = torch.tensor([[5.8, 0, 1.2]], device='cuda:0').repeat(batch_size,1)
    waypoints_torch = [
                torch.tensor([
                              [-0.2, -0.1, 1.4],
                              [1.6, 0.7, 1.1],
    ...
    # destination_positions_torch = torch.tensor([[5.8, 0, 1.3]], device='cuda:0').repeat(batch_size,1)
    ...
    # destination_positions_torch = torch.tensor([[2.0, 0.0, 1.2]], device='cuda:0').repeat(batch_size,1)
    # waypoints_torch = [
    #             torch.tensor([
    #                           [-0.2, -0.1, 1.4],
