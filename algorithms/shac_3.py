...
class SHAC3:
    ...
    def compute_actor_loss(self, deterministic = False):
        ...
        for i in range(self.steps_num):
            ...
            # update VAE
            recons_loss, vel_loss, kld_loss = self.vae_closure(obs, vel_obs, history_obs, done)
        ...
        self.vae_loss = mean_recons_loss + self.velo_weight * mean_vel_loss + self.kl_weight * mean_kld_loss
    ...
    def vae_closure(self, obs, vel_obs, history_obs, done):
        ...
        return recons_loss.item(), vel_loss.item(), kld_loss.item()
