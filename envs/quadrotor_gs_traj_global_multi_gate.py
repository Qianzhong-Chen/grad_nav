...
class QuadrotorGSMaskPosTrajGlobalMultiGateEnv(DFlexEnv):
    ...
    def __init__(self, 
        ...
        num_act = 4
        self.agent_name = 'quadrotor_gs_mask_pos_traj_global_multi_gate'
        self.num_history = HISTORY_BUFFER_NUM
        self.num_latent = LATENT_VECT_NUM
    
        print('----------------------------', device)
        super(QuadrotorGSMaskPosTrajGlobalMultiGateEnv, self).__init__(num_envs, num_obs, num_act, episode_length, MM_caching_frequency, seed, no_grad, render, device)
